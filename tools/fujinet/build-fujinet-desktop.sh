...
# for the Bally Astrocade desktop app.
#
...
#
# fnconfig.ini is forced to [BOIP] enabled=1 host=127.0.0.1 port=11500
# (ASTROSESSION_BOIP_PORT). Note what that means for THIS target: the RS232
...
echo "FujiNet Astrocade desktop runtime outputs:"
