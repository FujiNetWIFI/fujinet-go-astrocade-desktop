#!/usr/bin/env python3
"""Assert that a WITH_ASTROCADE_ROMS=OFF binary really carries no Bally system ROMs.
...
There is no freely-redistributable class of ROM here: the Astrocade on-board
BIOS (astro.bin and its Bally Computer System / Home Library variants) is
copyrighted Bally firmware, so a WITH_ASTROCADE_ROMS=OFF binary is expected
