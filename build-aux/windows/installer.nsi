...
; installer.nsi, renamed for Astrocade.
;
...
!endif
!ifndef SRCDIR
  !define SRCDIR "dist\FujiNet-Go-Astrocade"
!endif
!ifndef OUTFILE
  !define OUTFILE "FujiNet-Go-Astrocade-Setup.exe"
!endif
...
!define APPNAME    "FujiNet Go Astrocade"
!define PUBLISHER  "Thomas Cherryhomes"
!define EXENAME    "fujinet-go-astrocade-windows.exe"
!define HOMEPAGE   "https://fujinet.online/"
!define REGAPP     "Software\FujiNetGoAstrocade"
!define REGUNINST  "Software\Microsoft\Windows\CurrentVersion\Uninstall\FujiNetGoAstrocade"
...
Section "Uninstall"
  ...
  ; fujinet-go-astrocade and %LOCALAPPDATA%\fujinet-go-astrocade and are
  ; deliberately left behind: an uninstall should not throw away someone's
  ; configuration, and a reinstall picks it straight back up.
SectionEnd
